...
- **`earnings_sentiment_tool`** (earnings-call verbosity study — corrected 2026-08-04;
  ...
  before) specifically to respect AV's rolling-24h quota window — see docs/AUTOMATION.md
...
Working through `docs/EXPERT_BRIEF.md` roadmap items 1-4, then a full stage-1 backfill:
