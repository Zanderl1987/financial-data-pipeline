...
PIPELINES: list[PipelineSpec] = [
    ...
    PipelineSpec(
        ...
        stage=1,
        tables=['fred_rates_gdp_interest_rates', 'fred_rates_gdp_money_supply', 'fred_rates_gdp_gdp', 'fred_rates_gdp_inflation', 'fred_rates_gdp_mortgage', 'fred_rates_gdp_commodities', 'fred_rates_gdp_exchange_rates', 'fred_rates_gdp_markets', 'fred_rates_gdp_federal_debt'],
        requires_env=['FRED_API_KEY'],
        backfill_args=['--backfill'],
        timeout=900,
    ),
